...
export const productsHistoryDataSchema = Type.Pick(productsHistorySchema, ['text'], {
...
export const productsHistoryQueryProperties = Type.Pick(productsHistorySchema, ['id', 'text'])
